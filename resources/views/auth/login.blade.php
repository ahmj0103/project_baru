...
<html lang="en">
  ...
  <body style="background: #cfbf0a;font-family: 'Roboto Condensed';"  id="fakeLoader">
    <div class="container" style="text-align: center;margin-top: 100px">
          <h1 style="text-align: center;margin-bottom: 30px;color:#ffffff">Sistem Informasi Klinik UNP</h1>
          <br>
          ...
          <a data-toggle="modal" href='#modal-kepala_klinik'><img src="{{URL::to('images/kepala_klinik.png')}}"></a>
    </div>
    {{-- Modal resepsionist --}}
    ...
    {{--modal kepala_klinik--}}
    <div class="modal fade" id="modal-kepala_klinik">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title">Login kepala_klinik</h4>
          </div>
          <div class="modal-body">
            <form action="{{ route('login') }}" method="post">
              {{ csrf_field() }}
